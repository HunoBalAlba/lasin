...
@template(route="/g_cursos", title="Gestion de Cursos")
def g_cursos() -> rx.Component:
    """The dashboard page.
    ...
    return rx.vstack(
        rx.cond(
            LoginState.is_Administrador,
                rx.vstack(
                    rx.heading("Gestion de Cursos", size="8"),
                    rx.text(" crud "),
                    rx.text(
                        "En esta pagina podras adicionar nuevos cursos y editar",
