...
@template(route="/g_docentes", title="Gestion de Docentes")
def g_docentes() -> rx.Component:
    """The dashboard page.
    ...
    return rx.vstack(
        rx.cond(
            LoginState.is_Administrador,
                rx.vstack(
                    rx.heading("Gestion de Docentes", size="8"),
                    rx.text(" crud "),
                    rx.text(
                        "En esta pagina podras adicionar nuevos docentes y editar",
